...
jQuery.noConflict()(function(e){"use strict";e(function(){e("#my-menu").mmenu({extensions:["theme-dark","border-offset","fx-listitems-slide","listview-huge","pagedim-black"],navbar:{title:"DELICATE"}}),e("#my-menu").data("mmenu").bind("open:start",function(){e(".hamburger").addClass("is-active"),e("#my-menu").css("display","block")}).bind("close:finish",function(){e(".hamburger").removeClass("is-active"),e("#my-menu").css("display","none")}),e("#footer_gallery").owlCarousel({items:1,loop:!0,margin:0,nav:!1,dots:!1,navText:"",smartSpeed:1e3}),e("#owl-salads").owlCarousel({items:4,loop:!0,margin:0,nav:!0,dots:!0,navText:"",smartSpeed:1e3,responsive:{0:{items:1},500:{items:1},600:{items:2},1000:{items:4}}}),e("#owl-drinks").owlCarousel({items:3,loop:!0,margin:0,nav:!0,dots:!0,navText:"",smartSpeed:1e3,responsive:{0:{items:1},600:{items:1},1000:{items:3}}}),e("#owl").owlCarousel({items:3,loop:!0,margin:0,nav:!0,dots:!0,navText:"",smartSpeed:1e3,responsive:{0:{items:1},600:{items:1},1000:{items:3}}}),e(".owl-carousel").owlCarousel({items:1,loop:!0,margin:500,nav:!0,navText:"",smartSpeed:1e3})})});